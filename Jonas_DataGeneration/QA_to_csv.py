...
def q_and_a_to_csv(input_file_path, output_file_path):
    ...
    for i in range(0, len(lines), 2):  # Step by 10 to account for 5 Q&A pairs
        messages = {"messages": []}
        for j in range(0, 2, 2):  # Step by 2 within the group of 10 lines
...
test_input_file_path = 'data/test.txt'
test_output_file_path = 'data/test.csv'
